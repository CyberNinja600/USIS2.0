                    ...
                    <div>
                        <div class="tm-brand-box">
                            <h1 class="tm-brand"><center> Welcome!                          
                                  ...
                                  $sql = "Select Name from faculty_personalinfo WHERE ID='$userid_login'";
                        ...
                        <div class="row">
                            <div class="col-lg-6 tm-col-home mb-4">
                                ...
                                <div class="tm-text-container">
                                    ...
                                    <?php
                                    $sql = "Select dob from faculty_personalinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>
                                    ...
                                    <?php
                                    $sql = "Select Nationality from faculty_personalinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>
                                    ...
                                    <?php
                                    $sql = "Select mailingAddress from faculty_personalinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>
                                    <p><strong>
                                     ...
                                     <?php
                                    $sql = "Select permanentAddress from faculty_personalinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>
                            ...
                            <div class="col-lg-6 tm-col-home mb-4">
                                <div class="tm-text-container">
                                    <div class="tm-icon-container mb-5 mr-0 ">
                                     ...
                                     <?php
                                    $sql = "Select Gender from faculty_personalinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>
                                    <p><strong>
                                     ...
                                     <?php
                                    $sql = "Select phone from faculty_personalinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>
                                    <p><strong>
                                      <a style="color:#34568B";>Phone : </a>+88<?php echo $row[0];}?>
                                    </strong></p>


                                     <?php
                                    $sql = "Select ID from faculty_personalinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>
                                    <p><strong>
                                     ...
                                     <?php
                                    $sql = "Select BloodType from faculty_personalinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>
                                    <p><strong>
                                     ...
                                     <?php
                                    $sql = "Select userEmail from faculty_personalinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>
                                ...
                                <div class="tm-text-container">
                                    <div class="tm-icon-container mb-5 mr-0">
                                        <i class="fas fa-portrait fa-4x tm-text-primary"></i>
                                                                          ...
                                                                          <?php
                                    $sql = "Select ID from faculty_careerinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>                      
                                    <p><strong>
                                     ...
                                     <?php
                                    $sql = "Select department from faculty_careerinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>    
                            ...
                            <div class="col-lg-6 tm-col-home mb-4">
                                <div class="tm-text-container">
                                    <div class="tm-icon-container mb-5 mr-0 ">
                                     ...
                                     <?php
                                    $sql = "Select JoiningDate from faculty_careerinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                                    ?>                                  
                                    <p><strong>
                                     ...
                                     <?php
                                    $sql = "Select course_code from faculty_careerinfo WHERE ID='$userid_login'";
                                    $result = mysqli_query($conn,$sql);
                                    if(mysqli_num_rows($result)!=0)
                                      while($row=mysqli_fetch_array($result)){
                    ...
                    <section id="about" class="tm-section">
                        ...
                        <div class="row tm-row-about">
                            <div class="tm-col-about tm-col-about-l">
                                <p class="mb-4">
                                  <strong>Here you can see all the students that took your course, Take your time and find out what they are into!</strong>
                            </div>
                        ...
                        <div class="mt-5">
                            <div class="tm-carousel">
                                ...
                                <?php
                                    ...
                                    $sql = "UPDATE `courses_faculty_info` SET `NumberOfStudents`='$studentnumber' WHERE userid_login='$userid_login' ";
                                    $result = mysqli_query($conn,$sql);

                                    #update seat
                                    $update_Seat=40-$studentnumber;

                                    $sql = "UPDATE `course_offered` SET `course_seat`='$update_Seat' WHERE course_code='$temp' ";
                                    $result = mysqli_query($conn,$sql);
                                ?>
                                      ...
                                      for($unique=0;$unique<$studentnumber;$unique++)
                                      {
                                        echo '<div class="tm-carousel-item">
                                          ...
                                          <?php     
                                                    ...
                                                    $forstudentid=[];
                                                    $sql = "Select userid_login from courses_student_info WHERE course_1='$courseteacherteaching1' OR course_2='$courseteacherteaching1' OR course_3='$courseteacherteaching1' OR course_4='$courseteacherteaching1' OR course_5='$courseteacherteaching1'";
                                                    $result = mysqli_query($conn,$sql);
                                                    if(mysqli_num_rows($result)!=0)
                                                      while($row=mysqli_fetch_array($result))
                                                      {
